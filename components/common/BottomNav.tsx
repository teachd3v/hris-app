  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 md:hidden z-50 pb-safe pointer-events-none">
      <div className="relative w-full max-w-md mx-auto pointer-events-auto h-[76px] mt-[30px]">
        ...
        >
          <path d="M0 24C0 10.7452 10.7452 0 24 0H133.488C142.135 0 149.957 4.90809 154.214 12.3956L158.077 19.1895C163.69 29.0567 174.523 35.15 186.082 35.15C198.544 35.15 210.057 28.1633 215.656 17.2917L219.043 10.7135C223.361 2.32759 232.062 -3.07684e-05 241.469 -2.99464e-05H351C364.255 -2.87853e-05 375 10.7452 375 24V76H0V24Z" fill="white"/>
        </svg>
